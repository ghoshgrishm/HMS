...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['record_prescription'])) {
        ...
        if ($res && mysqli_num_rows($res) > 0) {
            ...
            $insert = "INSERT INTO prescription (appointment_id, medicine_details, dosage, duration, charge)
                       VALUES ('$appointment_id', '$medicine_details', '$dosage', '$duration', '$charge')";
...
<!-- Step 3: Hidden prescription form -->
